...
public final class SendMessageEncoder
{
    ...
    public SendMessageEncoder hopCount(final byte value)
    {
    ...
    public static final class BindingLogicServerIdsEncoder
    {
        ...
        private final SendMessageEncoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BindingLogicServerIdsEncoder(final SendMessageEncoder parentMessage)
        {
    ...
    public SendMessageEncoder putData(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 61440)
        {
    ...
    public SendMessageEncoder putData(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 61440)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public SendMessageEncoder putAttachment(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1024)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public SendMessageEncoder putAttachment(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1024)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
