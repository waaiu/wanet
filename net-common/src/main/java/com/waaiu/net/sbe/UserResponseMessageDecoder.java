...
public final class UserResponseMessageDecoder
{
    ...
    private final UserResponseMessageDecoder parentMessage = this;
    ...
    public UserResponseMessageDecoder wrap(
    ...
    public UserResponseMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public UserResponseMessageDecoder sbeRewind()
    {
    ...
    {
        return buffer.getShort(offset + 77, BYTE_ORDER);
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[UserResponseMessage](sbeTemplateId=");
    ...
    public UserResponseMessageDecoder sbeSkip()
    {
        sbeRewind();
        skipErrorMessage();
        skipData();
