...
public final class ConnectRequestMessageEncoder
{
    ...
    private final ConnectRequestMessageEncoder parentMessage = this;
    ...
    public ConnectRequestMessageEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ConnectRequestMessageEncoder wrapAndApplyHeader(
    ...
    public ConnectRequestMessageEncoder futureId(final long value)
    {
    ...
    public static final class CmdMergesEncoder
    {
        ...
        private final ConnectRequestMessageEncoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        CmdMergesEncoder(final ConnectRequestMessageEncoder parentMessage)
        {
    ...
    public static final class PayloadEncoder
    {
        ...
        PayloadEncoder(final ConnectRequestMessageEncoder parentMessage)
        {
            this.parentMessage = parentMessage;
        }
