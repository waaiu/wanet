...
public final class ResponseMessageDecoder
{
    ...
    public ResponseMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ResponseMessageDecoder sbeRewind()
    {
    ...
    {
        return buffer.getShort(offset + 69, BYTE_ORDER);
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ResponseMessage](sbeTemplateId=");
    ...
    public ResponseMessageDecoder sbeSkip()
    {
        sbeRewind();
        skipErrorMessage();
        skipData();
