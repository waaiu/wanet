...
public final class ServerOfflineMessageDecoder
{
    ...
    private final ServerOfflineMessageDecoder parentMessage = this;
    ...
    public ServerOfflineMessageDecoder wrap(
    ...
    public ServerOfflineMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ServerOfflineMessageDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ServerOfflineMessage](sbeTemplateId=");
    ...
    public ServerOfflineMessageDecoder sbeSkip()
    {
        sbeRewind();
