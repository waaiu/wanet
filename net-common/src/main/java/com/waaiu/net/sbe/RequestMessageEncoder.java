...
public final class RequestMessageEncoder
{
    ...
    public RequestMessageEncoder wrapAndApplyHeader(
    ...
    public RequestMessageEncoder hopCount(final byte value)
    {
        buffer.putByte(offset + 69, value);
        return this;
    }
    ...
    public static final class BindingLogicServerIdsEncoder
    {
        ...
        private final RequestMessageEncoder parentMessage;
        private MutableDirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BindingLogicServerIdsEncoder(final RequestMessageEncoder parentMessage)
        {
    ...
    public RequestMessageEncoder putData(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 61440)
        {
    ...
    public RequestMessageEncoder putData(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 61440)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public RequestMessageEncoder putAttachment(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1024)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public RequestMessageEncoder putAttachment(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1024)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
