...
public final class EmptyExternalResponseMessageDecoder
{
    ...
    private final EmptyExternalResponseMessageDecoder parentMessage = this;
    ...
    public EmptyExternalResponseMessageDecoder wrap(
    ...
    public EmptyExternalResponseMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public EmptyExternalResponseMessageDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[EmptyExternalResponseMessage](sbeTemplateId=");
    ...
    public EmptyExternalResponseMessageDecoder sbeSkip()
    {
        sbeRewind();
        skipErrorMessage();
