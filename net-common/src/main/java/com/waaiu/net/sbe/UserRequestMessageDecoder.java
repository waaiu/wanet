...
public final class UserRequestMessageDecoder
{
    ...
    private final UserRequestMessageDecoder parentMessage = this;
    ...
    public UserRequestMessageDecoder wrap(
    ...
    public UserRequestMessageDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public UserRequestMessageDecoder sbeRewind()
    {
    ...
    {
        return buffer.getInt(offset + 69, BYTE_ORDER);
    }
    ...
    public int msgId()
    {
        return buffer.getInt(offset + 73, BYTE_ORDER);
    }
    ...
    public byte stick()
    {
        return buffer.getByte(offset + 77);
    }
        ...
        implements Iterable<BindingLogicServerIdsDecoder>, java.util.Iterator<BindingLogicServerIdsDecoder>
    {
        ...
        private final UserRequestMessageDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        BindingLogicServerIdsDecoder(final UserRequestMessageDecoder parentMessage)
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[UserRequestMessage](sbeTemplateId=");
        ...
        builder.append('|');
        builder.append("cacheCondition=");
        builder.append(this.cacheCondition());
        builder.append('|');
        builder.append("msgId=");
        builder.append(this.msgId());
        builder.append('|');
        builder.append("stick=");
        builder.append(this.stick());
        builder.append('|');
    ...
    public UserRequestMessageDecoder sbeSkip()
    {
        sbeRewind();
