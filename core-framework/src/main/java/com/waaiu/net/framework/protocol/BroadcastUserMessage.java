 ...
 * <p>
 * Extends {@link BroadcastMessage} with {@link UserIdentity} for user binding
 * and
 * {@link CommonResponse} for error propagation. Used to push data to one
 * specific
 * connected user identified by {@code userId}, routed through the external
 * server
